...
// Task Priorities
#define DRIVE_ARDUINO_COMM_PRIORITY 6
#define FPGA_COMM_PRIORITY 3
#define TCP_VIDEO_PRIORITY 2
#define TCP_COMMAND_PRIORITY 7
#define READ_VIDEO_FRAME_PRIORITY 2
#define EXPLORATION_PRIORITY 6

// Delay timings
#define TCP_COMMAND_INTERVAL 1000
#define TCP_VIDEO_INTERVAL 1000
#define I2S_VIDEO_INTERVAL 1000
