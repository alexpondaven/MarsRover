...
output	[23:0]			  	   source_data2;
output								source_valid2;
input									source_ready2;
output								source_sop2;
output								source_eop2;
...
wire         sop, eop, in_valid, out_ready, out_ready1, out_ready2;

assign out_ready = mode[3] ? out_ready1 : out_ready2;
////////////////////////////////////////////////////////////////////////
...
STREAM_REG #(.DATA_WIDTH(26)) out_reg2 (
	.clk(clk),
	.rst_n(reset_n),
